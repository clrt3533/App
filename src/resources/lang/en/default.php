...
return array_merge([
    ...
    'are_you_sure_to_delete_this_inventory' => 'Are you sure you want to delete this inventory',
    'inventory' => 'Inventory',
    ...
    'are_you_sure_to_delete_this_receipt' => 'Are you sure to delete this receipt',
    ...
    'layout_description' => 'RTL does not support PDF invoices.',
    'currency_description' => 'Estimate/Invoice PDF will not support all currency symbols. We recommend using currency codes like USD, EUR, NOK, etc.',
    ...
    'estimates' => 'Estimates',
    'estimate' => 'Estimate',
    'create_estimates' => 'Create estimate',
    'delete_estimates' => 'Delete estimate',
    'view_estimates' => 'View estimate',
    'estimate_resend' => 'Resend estimate',
    'clone_estimates' => 'Clone estimate',
    'clone_invoice' => 'Clone as invoice',
    'update_estimates' => 'Update estimate',
    'new_estimates' => 'Add estimate',
    'estimate_number' => 'Estimate number',
    'add_estimates' => 'Add estimate',
    'clone_as_invoice' => 'Clone as invoice',
    'estimate_cloned_as_invoice' => 'Estimate cloned as invoice',
    'download_estimate' => 'Download',
    'estimate_sending' => 'Estimate sending',
    'estimate_send_success' => 'Estimate send success',
    'are_you_sure_to_delete_this_estimates' => 'Are you sure to delete this estimates',
    'contact' => 'Contact',
    'product' => 'Product',
    'quantity' => 'Quantity',
    'discount' => 'Discount',
    ...
    'setup_email_address' => 'You need to setup the Email settings on Settings. After creating an invoice, an email will automatically be sent to the client\'s email.',
    'setup_email_address_for_estimate' => 'You need to setup the Email settings on Settings. After creating an estimate, an email will automatically be sent to the client\'s email.',
    ...
    'unpaid' => 'Unpaid',
    'overdue' => 'Overdue',
    'for_cpanel_service_provider' => 'For cpanel service provider',
    'please_copy_the_command' => 'Please copy the command below and insert into your hosted server\,s crontab.',
    'all_users' => 'All users',
    'active' => 'Active',
    'inactive' => 'Inactive',
    'invited' => 'Invited',
    ...
    'client_invite_note' => 'After adding the client, the client will receive an email with application login access',
    'payment_received' => 'Payment received',
    'invoice_clone_note' => 'Invoice clone note'
