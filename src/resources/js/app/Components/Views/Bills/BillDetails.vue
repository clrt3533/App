  ...
  <div>
    <div class="content-wrapper">
      <div class="d-flex align-items-center justify-content-between">
        <app-breadcrumb :page-title="$t('bill_details')" />
        <div class="mb-4">
          <button
              ...
              <table class="cus-w-100 cus-font-xm cus-table-strip" border="0" cellspacing="0" cellpadding="0">
                <thead>
                  <tr class="cus-bg-dark cus-text-light">
                    ...
                    <!-- Client name -->
                    <th class="cus-w-25 cus-p-1 cus-text-left">
                      <p v-if="formData.bill.invoice.client_name" class="cus-bold">{{ $t('Name') }}: {{
                        formData.invoice.client_name }}</p>
                    </th>

                    <!-- Client contact -->
                    <th class="cus-w-25 cus-p-1 cus-text-center">
                      <p v-if="formData.bill.invoice.client_number">{{ $t('contact') }}: {{
                        formData.bill.invoice.client_number }}</p>
                    </th>
              ...
              <table class="cus-w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ numberWithCurrencySymbol(formData.bill.transport) }}</td>
                    </tr>

                    <tr>
                        <td>2</td>
                        <td>Packing charges</td>
                        <td>{{ numberWithCurrencySymbol(formData.bill.packing) }}</td>
                    </tr>

                    <tr>
                        <td>3</td>
                        <td>Loading charges</td>
                        <td>{{ numberWithCurrencySymbol(formData.bill.loading) }}</td>
                    </tr>

                    <tr>
                        <td>4</td>
                        <td>Unloading charges</td>
                        <td>{{ numberWithCurrencySymbol(formData.bill.unloading) }}</td>
                    </tr>
...
export default {
  ...
  methods: {
    ...
    downloadBill() {
      ...
      window.open(AppFunction.getAppUrl(`bill-download/${this.formData.bill.id}`));
    },
    formatDate(date) {
